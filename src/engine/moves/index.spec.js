...
describe('getRookMoves()', () => {
  ...
  it('should capture in all directions', () => {
    const board = sanBuildBoard('white R e4, black P e2, black P e6, black P g4, black P c4');
    expectMoves(getRookMoves(board, san('e4')),
        san('e3 e2 e5 e6 f4 g4 d4 c4')
    );
  });
...
describe('getKnightMoves()', () => {
  it('should follow the movement rules for a knight', () => {
    ...
    expectMoves(getKnightMoves(board, san('e5')), san('d7 f7 g4 g6 c4 c6 d3 f3'));
  });
  it('should not be blocked by pieces', () => {
    const board = sanBuildBoard('white N e5, white P d6, white P e6, white P f6, ' +
  ...
  it('should capture opponent pieces', () => {
    const board = sanBuildBoard('white N e5, black P d7, black P f7, black P g4, ' +
